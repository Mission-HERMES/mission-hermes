...
if (aiOutput && aiQuestion && aiAskBtn) {
    const aiKnowledge = [
        ...
        { key: "température", "dehors", "froid", "chaud",  answer: "La température extérieure est de –63°C. L’exposition directe est déconseillée." },
        { key: "tempête", "météo", "temps",                answer: "Aucune tempête détectée dans un rayon de 12 km." },
        { key: "vent",                                     answer: "Vent faible, 14 km/h, direction nord‑est." },
        { key: "radiation", "rayonnement",                 answer: "Radiation solaire modérée. Combinaison renforcée recommandée." },
        { key: "pression",                                 answer: "Pression atmosphérique instable, sortie extravéhiculaire non autorisée." },
